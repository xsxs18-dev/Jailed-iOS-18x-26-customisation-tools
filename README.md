...
| :--- | :--- | :--- | :--- |
| **cyanide-ios** | iOS 16.0+ | Advanced open-source **Jailed Package Manager** designed to organize, queue, and deploy non-jailbreak modifications and themes directly to the device. | [GitHub Repository](https://github.com/zeroxjf/cyanide-ios) |
