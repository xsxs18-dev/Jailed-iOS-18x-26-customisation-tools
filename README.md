...
| **Accessible** | 16.0+ | Jailed filesystem utility built as an iOS Shortcut — no exploits at all, so no elevated access. Lets you browse `/System`, `/private/preboot`, open hidden internal apps, and pull your MobileGestalt. | [GitHub](https://github.com/jailbreakdotparty/Accessible) |
...
| **Omega** | iOS 26 and earlier | Clears the enterprise-cert blacklist/revoke database using SparseRestore, so sideloaded apps stop getting blocked. Dev has said this version will never support anything newer without a new file-write exploit. | [GitHub](https://github.com/jailbreakdotparty/BlacklistBeGone) |
